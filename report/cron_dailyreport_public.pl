...
@recipients = qw( mikocheng@aptg.com.tw hjason@aptg.com.tw );
...
system "/mico/report/mico-statistics.pl '/backup/maillog/mx0[1234]*$YESTERDAY*' > /mico/report/mx_mico-statistics.log";
print "Generating SMTP logs : statistics\n";
system "/mico/report/mico-statistics.pl '/backup/maillog/smtp*$YESTERDAY*' > /mico/report/smtp_mico-statistics.log";

#-------------------- MX logs report -----------------------------
print "Generating MX logs : mailfrom\n";
system "/mico/smtpd_statistics.pl mailfrom $topn '/backup/maildebug/mx0[1234]*$YESTERDAY*' > /mico/report/mx_mailfrom_mico-statistics.log";

print "Generating MX logs : ip\n";
system "/mico/smtpd_statistics.pl ip $topn '/backup/maildebug/mx0[1234]*$YESTERDAY*' > /mico/report/mx_ip_mico-statistics.log";

print "Generating MX logs : spammail\n";
system "/mico/smtpd_statistics.pl spammail $topn '/backup/maillog/mx0[1234]*$YESTERDAY*' > /mico/report/mx_spammail_mico-statistics.log";

print "Generating MX logs : error\n";
system "/mico/smtpd_statistics.pl error $topn '/backup/maillog/mx0[1234]*$YESTERDAY*' > /mico/report/mx_error_mico-statistics.log";

#-------------------- SMTP logs report -----------------------------
print "Generating SMTP logs : mailfrom\n";
system "/mico/smtpd_statistics.pl mailfrom $topn '/backup/maildebug/smtp*$YESTERDAY*' > /mico/report/smtp_mailfrom_mico-statistics.log";

print "Generating SMTP logs : ip\n";
system "/mico/smtpd_statistics.pl ip $topn '/backup/maildebug/smtp*$YESTERDAY*' > /mico/report/smtp_ip_mico-statistics.log";

print "Generating SMTP logs : spammail\n";
system "/mico/smtpd_statistics.pl spammail $topn '/backup/maillog/smtp*$YESTERDAY*' > /mico/report/smtp_spammail_mico-statistics.log";

print "Generating SMTP logs : error\n";
system "/mico/smtpd_statistics.pl error $topn '/backup/maillog/smtp*$YESTERDAY*' > /mico/report/smtp_error_mico-statistics.log";

#-------------------- MS logs report ------------------------------
print "Generating MS logs : mailfrom\n";
system "/mico/smtpd_statistics.pl mailfrom $topn '/backup/maildebug/ms*$YESTERDAY*' > /mico/report/ms_mailfrom_mico-statistics.log";

print "Generating MS logs : ip\n";
system "/mico/smtpd_statistics.pl ip $topn '/backup/maildebug/ms*$YESTERDAY*' > /mico/report/ms_ip_mico-statistics.log";

print "Generating MS logs : error\n";
system "/mico/smtpd_statistics.pl error $topn '/backup/maildebug/ms*$YESTERDAY*' > /mico/report/ms_error_mico-statistics.log";
